...
void	init_image_define_size(t_data *data)
{
	...
	init_image_set_size(&data->milx.mini[0], MINI_MAP + MM_BORDER_SIZE, MINI_MAP + MM_BORDER_SIZE);
	init_image_set_size(&data->milx.mini[1], MINI_MAP + MM_BORDER_SIZE, MINI_MAP + MM_BORDER_SIZE);

}

void	init_image(t_data *data)
{
	data->milx.mini[0].img = mlx_new_image(data->milx.mlx, MINI_MAP + MM_BORDER_SIZE, MINI_MAP + MM_BORDER_SIZE);
	data->milx.mini[1].img = mlx_new_image(data->milx.mlx, MINI_MAP + MM_BORDER_SIZE, MINI_MAP + MM_BORDER_SIZE);
